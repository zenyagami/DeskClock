...
/**
 * Class to measure and draw the time in the {@link com.zenkun.deskclock.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link com.zenkun.deskclock.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
